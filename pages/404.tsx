...
export default function PageNotFound() {
  return (
    ...
    <div className="mx-auto px-5 sm:px-10 md:px-10 lg:px-30 bg-slate-100 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center h-[70vh]">
        <div className="text-center text-gray-700 dark:text-white">
          ...
          <p className="my-4 max-w text-sm text-center text-gray-600 dark:text-gray-400">The page you are looking for does not exist.</p>

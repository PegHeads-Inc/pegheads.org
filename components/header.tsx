  ...
  <section className="flex py-2 text-xs items-center justify-center bg-black-900 text-gray-200 dark:text-gray-400">
    <div className="flex text-center">
      ...
      <div className="flex items-center underline">
        ...
        <Link href="mailto:hello@aiblockchainventures.com" className="ml-1">
    ...
    <div className="mx-auto px-4 sm:px-6">
      <div className="flex justify-between items-center py-4">
        ...
        <nav className="hidden md:flex space-x-7">
          <Link
            href="/"
            className="font-medium text-xs hover:underline hover:text-purple-200">
            Home
          </Link>
          <Link
            href="/tutorials"
                ...
                <div className="pt-5 pb-6 px-5">
                  <div className="mt-6">
                    <nav className="grid gap-y-8">
                      <Link href="/" className="pl-3 font-medium text-xs" onClick={handleClick}>
                      ...
                      <Link href="/about" className="pl-3 font-medium text-xs" onClick={handleClick}>
